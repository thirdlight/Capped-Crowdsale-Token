...
1. Created `uint256 tokensLeft`, which is set in the constructor (`tokensLeft = _cap * _rate`) and appropriately subtracted after each transaction (`tokensLeft = tokensLeft.sub(_weiAmount* this.rate())`). The `function getTokensLeft()` return tokensLeft;
...
{ tx:
  ...
  receipt:
   { transactionHash:
     ...
     transactionIndex: 0,
     blockHash:
      '0xfe49d1e19ba4c81c308147805597ae7983f6735a62bbe888140d0f46b1f15335',
     blockNumber: 9,
     from: '0xabad44f494343dc39678e5d645cb98e4037cb1b2',
     to: '0xadf384c858cb10d5a5d63086367c0653eba5b987',
     gasUsed: 108927,
     cumulativeGasUsed: 108927,
     contractAddress: null,
     logs: [],
     status: true,
     logsBloom:
      '',
     v: '0x1b',
     r:
      '0xc1b607f9d65337d1edfaa790bd522b14df2f8fca192990d9e11f43577c33df76',
     s:
