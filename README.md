...
This program creates a Solidity contract for a basic capped crowd sale token. The code for this project is based off this tutorial, but updated to be compliant with the new version of Solidity.
<br />
## Getting Started
### Dependencies
Truffle v5.0.7
